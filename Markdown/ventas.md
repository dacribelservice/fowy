...
- [ ] **Paso 1.1 — Creación del Hook Base y Definición de Tipos**
  ...
  - **Verificación**: Archivo creado sin errores de sintaxis ni de TypeScript.

- [ ] **Paso 1.2 — Lógica de Fetching y Procesamiento Temporal en Supabase**
  - **Acción**: Desarrollar la consulta `select` a `analytics_visits` y `businesses` agrupando visitas y clics por intervalos de tiempo (Día, Semana, Mes).
  - **Alcance**: Retornar `{ loading, points, maxVisits, maxClicks, totalPeriodVisits, totalPeriodClicks }` con sanitización anti-NaN.
  - **Verificación**: El hook compila limpiamente sin advertencias de tipos.

---

### 🔹 FASE 2: Renderizado Visual SVG (`BusinessTrafficSvg.tsx`)

- [ ] **Paso 2.1 — Estructura SVG Base y Cálculo de Ejes Vectoriales**
  ...
  - **Verificación**: El componente renderiza el lienzo SVG base limpio.

- [ ] **Paso 2.2 — Renderizado de la Curva de Visitas y Barras Verdes de WhatsApp**
  ...
  - **Verificación**: Curva y barras vectoriales dibujadas armónicamente sin superposiciones erróneas.

- [ ] **Paso 2.3 — Implementación de Tooltips Flotantes e Interacción Tactil/Hover**
  ...
  - **Verificación**: Tooltip dinámico funcionando al pasar el cursor sobre los datos.

---

### 🔹 FASE 3: UI Contenedora y Controles (`BusinessTrafficChart.tsx`)

- [ ] **Paso 3.1 — Creación del Contenedor UI y Cabecera de Filtros**
  ...
  - **Verificación**: Interfaz con estilo Fowy rendered correctamente con estado de filtro reactivo.

- [ ] **Paso 3.2 — Integración con Skeleton Loader y Subcomponente SVG**
  ...
  - **Verificación**: Componente completo funcionando de manera autónoma.

---

### 🔹 FASE 4: Vinculación Final en el Orquestador

- [ ] **Paso 4.1 — Instanciación en la Página de Detalles (`page.tsx`)**
  ...
  - **Verificación**: El orquestador mantiene sus ~221 líneas sin sobrepasar el límite de 250 líneas.

- [ ] **Paso 4.2 — Verificación de Compilación y Control de Calidad**
  - **Acción**: Ejecutar comprobación de sintaxis/build para verificar que no hay errores de TS en Vercel ni fallos de renderizado en navegador.
  - **Alcance**: Garantizar que el sitio funciona fluidamente.
  - **Verificación**: Prueba de compilación limpia y funcional.
