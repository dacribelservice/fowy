...
- [x] **6.1. Diagnóstico de soporte:** Identificar el fallo síncrono al instanciar [getMessaging](file:///c:/Users/cange/Documents/fowy/src/modules/notifications/firebase.ts#L20) en WebViews/navegadores sin soporte de Push API.
- [x] **6.2. Envoltura try-catch en inicialización:** Modificar [firebase.ts](file:///c:/Users/cange/Documents/fowy/src/modules/notifications/firebase.ts) para envolver la invocación de [getMessaging](file:///c:/Users/cange/Documents/fowy/src/modules/notifications/firebase.ts#L20) en un bloque `try/catch` y evitar el colapso a nivel de importación.
