...
export default function ModulosPage() {
  return (
    <ComingSoonOverlay
      ...
      description="Este módulo de integraciones y extensiones adicionales está en fase de desarrollo final. Estamos preparando los mejores complementos para potenciar tu negocio."
    >
