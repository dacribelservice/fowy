...
export default function ExpertPanelPage() {
  ...
  return (
    <ComingSoonOverlay
      ...
      description="El Panel de Control de Expertos de FOWY está siendo calibrado. Muy pronto podrás gestionar tus entregas, balances y solicitudes de forma autónoma y eficiente."
    >
